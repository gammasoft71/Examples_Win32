...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
  ...
  case WM_ERASEBKGND: if (hwnd == label) { SetBkColor((HDC)wParam, GetBkColor(GetDC(form))); return 0; }
...
int main() {
  form = CreateWindowEx(0, WC_DIALOG, L"Hello world (label)", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 316, 330, nullptr, nullptr, nullptr, nullptr);
