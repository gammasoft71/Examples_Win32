...
HWND labelProduct;
HWND labelVersion;
HWND labelCompanyName;
HWND labelProductName;
HWND labelProductVersion;
...
int main(int argc, char* argv[]) {
  std::wstring currentModuleName(MAX_PATH, 0);
  ...
  std::wstring versionData(versionSize, 0);
